...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setGeometry(QRect(650, 10, 300, 20))
        ...
        self.findPB.setGeometry(QRect(10, 160, 75, 31))
        self.plainTextEdit = QPlainTextEdit(self.groupBox)
        self.plainTextEdit.setObjectName(u"plainTextEdit")
        self.plainTextEdit.setGeometry(QRect(90, 160, 151, 31))
        ...
        self.lcdNumber.setGeometry(QRect(340, 160, 111, 31))
        self.label = QLabel(self.groupBox)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(260, 160, 71, 31))
        font = QFont()
        ...
        self.menubar.setGeometry(QRect(0, 0, 967, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Product", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"ProductSubType", None))
