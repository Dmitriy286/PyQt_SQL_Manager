...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lcdNumber.setGeometry(QRect(530, 150, 111, 31))
        self.label = QLabel(self.groupBox)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(470, 150, 51, 31))
        font = QFont()
        ...
        self.plainTextEditConsole = QPlainTextEdit(self.groupBox)
        self.plainTextEditConsole.setObjectName(u"plainTextEditConsole")
        self.plainTextEditConsole.setGeometry(QRect(480, 30, 161, 111))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Rows:", None))
